...
/* -------------------------------------------------
   PLANE ICON (NO SMOOTH BANKING, JUST ROTATION)
-------------------------------------------------- */

function rotatePlaneIcon(headingDeg) {
...
/* -------------------------------------------------
   START FLIGHT (PLANE MOVES STRAIGHT)
-------------------------------------------------- */
...
function startFlight() {
    ...
    const interval = setInterval(() => {
        ...
        // Straight heading based on route
        const dx = endLon - startLon;
        const dy = endLat - startLat;
        const headingDeg = Math.atan2(dy, dx) * 180 / Math.PI;
        rotatePlaneIcon(headingDeg);
...
function finishFlight() {
    ...
    // ✅ LEVEL 1 COMPLETE → Show success screen
...
/* ==================================================
   LEVEL 2 – UI TRANSITION (FOREST INTRO)
================================================== */
...
function showLevel2Intro() {
    ...
    // Show Level 2 start card
    const lvl2 = document.getElementById("level2-screen");
    if (!lvl2) return;
...
/* -------------------------------------------------
   PROCEED TO SECTOR 2 (after Level 1 completion)
-------------------------------------------------- */

const toLevel2Btn = document.getElementById("goToLevel2Btn");
if (toLevel2Btn) {
    toLevel2Btn.addEventListener("click", showLevel2Intro);
}

/* -------------------------------------------------
   START LEVEL 2 (LOAD forest.html)
-------------------------------------------------- */
